...
public:
    // Default constructor (nødvendig når vi laver new[] i Spectrometer)
    SpectralMeasurement();

    // Constructor der initialiserer alle attributter
    ...
    // Getters (så vi kan beregne gennemsnit)
    float getWavelengthNm() const;
